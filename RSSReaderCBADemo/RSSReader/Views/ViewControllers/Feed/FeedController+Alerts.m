...
- (void)changeRssChannelAlert {
    ...
    UIAlertAction *bbsPickChannelAction = [UIAlertAction actionWithTitle:@"Washington"
    ...
    UIAlertAction *dailyMirrorPickChannelAction = [UIAlertAction actionWithTitle:@"Daily"
                                                                           style:UIAlertActionStyleDefault
                                                                         handler:^(UIAlertAction * _Nonnull action) {
                                                                             NSString *currentChannel = [userDefaults valueForKey:@"current_channel"];
